...
本 Demo 基于涂鸦智能云平台、涂鸦智能APP、IoTOS Embeded WiFi &Ble SDK，使用涂鸦WiFi/WiFi+BLE系列模组快速组建一个微波雷达传感器的demo，可以感应人体的存在，并将情况上传到手机 APP。
## 快速上手
